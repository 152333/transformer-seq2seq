...
from model import AblationTransformer_SingleHead
...
def main():
    # 创建结果目录
    os.makedirs('../results-base-SingleHeadAttention', exist_ok=True)
    ...
    # 初始化模型
    model = AblationTransformer_SingleHead(
    ...
    plt.legend()
    plt.savefig('../results-base-SingleHeadAttention/loss_curve.png')
    ...
    plt.legend()
    plt.savefig('../results-base-SingleHeadAttention/ppl_curve.png')
    ...
    plt.legend()
    plt.savefig('../results-base-SingleHeadAttention/cer_curve.png')

    print(f"所有指标曲线已保存至 ../results-base-SingleHeadAttention 目录")
